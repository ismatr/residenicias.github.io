...
<html lang="en">
    ...
    <body background="/sistema/assets/img/modelo-3-1024x576.jpg" aling= "center">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Usuario</label><input class="form-control py-4" id="inputEmailAddress" name="usuario" type="text" placeholder="" /></div>
                                            <div class="form-group"><label class="small mb-1" for="inputPassword">Contraseña</label><input class="form-control py-4" id="inputPassword" name="password" type="password" placeholder="" /></div>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="register.php">¿Necesito una cuenta? ¡Regístrate!</a></div>
									</div>
								</div>
							</div>
						</div>
