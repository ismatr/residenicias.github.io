        ...
        <div id="layoutSidenav">
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <form class="form-horizontal" method="POST" action="personal/guardar-personal.php">
                <div class="form-group row">
                  <label class="control-label col-md-3">Sap</label>
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="sap" value="<?=$Per->getsap()?>" placeholder="">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="puesto" value="<?=$Per->getpuesto()?>" placeholder="">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="ubicacion" value="<?=$Per->getubicacion()?>" placeholder="">
                  </div>
                </div>
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="nombrec" value="<?=$Per->getnombre_completo()?>" placeholder="">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="jefei" value="<?=$Per->getjefe_inmediato()?>" placeholder="">
                  </div>
                </div>
